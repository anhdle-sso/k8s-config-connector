...
type NetworkSecurityMirroringDeploymentStatus struct {
	...
	// A unique specifier for the NetworkSecurityMirroringDeployment resource in Google Cloud.
...
// NetworkSecurityMirroringDeploymentObservedState is the state of the NetworkSecurityMirroringDeployment resource as most recently observed in Google Cloud.
