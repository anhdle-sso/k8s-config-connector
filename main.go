...
//  go run . --remote upstream  --branch upstream/master --version-file version/VERSION  --source /usr/local/google/home/yuwenma/go/src/github.com/GoogleCloudPlatform/k8s-config-connector -v=2 --yes=true
import (
	"bufio"
	"bytes"
	"context"
