...
# Prow, specifically via the `periodic-cnrm-cleanup-no-age` job whose configuration
# can be found at
...
${REPO_ROOT}/google-internal/scripts/cleanup-leaked-test-resources-no-age.sh
